...
namespace DotNetNuke.Modules.eCollection_Teachers
{
    ...
    /// are accessible to your module's controls (that inherity from eCollection_TeachersSettingsBase
    /// 
    /// </summary>


    public class eCollection_TeachersSettingsBase : ModuleSettingsBase
    {
