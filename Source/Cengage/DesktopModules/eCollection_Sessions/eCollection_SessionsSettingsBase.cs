...
namespace DotNetNuke.Modules.eCollection_Sessions
{
    ...
    /// are accessible to your module's controls (that inherity from eCollection_SessionsSettingsBase
    /// 
    /// </summary>


    public class eCollection_SessionsSettingsBase : ModuleSettingsBase
    {
