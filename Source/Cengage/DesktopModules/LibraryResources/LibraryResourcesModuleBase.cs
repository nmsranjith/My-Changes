...
namespace DotNetNuke.Modules.LibraryResources
{
    ...
    /// are accessible to your module's controls (that inherity from LibraryResourcesModuleBase
    /// 
    /// </summary>

    public class LibraryResourcesModuleBase : DotNetNuke.Entities.Modules.PortalModuleBase
    {
    }
}
