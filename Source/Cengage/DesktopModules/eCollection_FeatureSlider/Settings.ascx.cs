...
namespace DotNetNuke.Modules.eCollection_FeatureSlider
{
    ...
    /// 
    /// Because the control inherits from eCollection_FeatureSliderSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : eCollection_FeatureSliderSettingsBase
    {
