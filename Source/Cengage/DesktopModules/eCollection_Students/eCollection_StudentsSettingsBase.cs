...
namespace DotNetNuke.Modules.eCollection_Students
{
    ...
    /// are accessible to your module's controls (that inherity from eCollection_StudentsSettingsBase
    /// 
    /// </summary>


    public class eCollection_StudentsSettingsBase : ModuleSettingsBase
    {
