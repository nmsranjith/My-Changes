...
<%@ Register TagPrefix="dnn" Namespace="DotNetNuke.Web.Client.ClientResourceManagement"
	...
	<dnn:DnnCssInclude runat="server" FilePath="Resources/Shared/stylesheets/Homelevelskin.css" Priority="14"  />
...
<div class="content_wrapper">
    <div class="container">
        ...
        <div id="TopPane" runat="server" class="corpLevelTopPane">
            ...
            <div id="LeftPane" runat="server" class="corpLvlLftPn leftPaneBorder">
            </div>
			<div class="corplvl_imgdiv"> 				 
                 <div class="corplvl_imgdiv1">
                  <img alt="" id="imgsepline" src="/Portals/0/images/separatorarrow.Png"></div></div>
				  <div class="corplvl_contdiv1">
            <div id="ContentPane" runat="server" class="corpLvlConPn">
            </div>
			</div>
          </div>
    </div>
