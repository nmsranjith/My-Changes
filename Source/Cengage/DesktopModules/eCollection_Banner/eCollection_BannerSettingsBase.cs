...
namespace DotNetNuke.Modules.eCollection_Banner
{
    ...
    /// are accessible to your module's controls (that inherity from eCollection_BannerSettingsBase
    /// 
    /// </summary>


    public class eCollection_BannerSettingsBase : ModuleSettingsBase
    {
