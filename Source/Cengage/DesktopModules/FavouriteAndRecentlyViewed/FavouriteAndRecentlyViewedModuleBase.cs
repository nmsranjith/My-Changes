...
namespace DotNetNuke.Modules.FavouriteAndRecentlyViewed
{
    ...
    /// are accessible to your module's controls (that inherity from FavouriteAndRecentlyViewedModuleBase
    /// 
    /// </summary>

    public class FavouriteAndRecentlyViewedModuleBase : DotNetNuke.Entities.Modules.PortalModuleBase
    {
    }
}
