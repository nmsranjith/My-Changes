...
namespace DotNetNuke.Modules.ProductFormat
{
    ...
    /// are accessible to your module's controls (that inherity from ProductFormatModuleBase
    /// 
    /// </summary>

    public class ProductFormatModuleBase : DotNetNuke.Entities.Modules.PortalModuleBase
    {
        /// <summary>
