...
<%@ Register TagPrefix="dnn" TagName="BROWSESEARCH" Src="~/controls/BrowseAndSearchControl.ascx" %>
...
<%@ Register TagPrefix="dnn" TagName="SOCIALMEDIACONTROL" Src="~/controls/SocialMediaControl.ascx" %>
<%@ Register TagPrefix="dnn" Namespace="DotNetNuke.Web.Client.ClientResourceManagement"
    Assembly="DotNetNuke.Web.Client" %>
<dnn:DnnCssInclude ID="bootstrapCSS" runat="server" FilePath="Resources/Shared/stylesheets/Primaryhomeskin.css" Priority="14" />
	<dnn:DnnCssInclude ID="bootstrapCSS1" runat="server" FilePath="Resources/Shared/scripts/Bootstrap/css/bootstrap.min.css" />
	<dnn:DnnCssInclude ID="bootstrapCSS2" runat="server" FilePath="Resources/Shared/scripts/Bootstrap/css/custom.css?v=2" />
...
<div class="content_wrapper">
    <div class="container">
	<dnn:BROWSESEARCH runat="server" id="BrowseSearch" clientidmode="Static" />
