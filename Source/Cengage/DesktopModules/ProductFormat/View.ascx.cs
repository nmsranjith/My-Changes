...
namespace DotNetNuke.Modules.ProductFormat
{
    ...
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class View : ProductFormatModuleBase, IActionable
    {
        ...
        private void Page_Load(object sender, System.EventArgs e)
        {
            try
            {
                ProductFormatsRptr.DataSource = ProductFormatController.Instance.GetAllProductFormats();
                ProductFormatsRptr.DataBind();
            }
