...
#TextSearchFooter{height:100% !important;width:715px !important;}
    ...
    #megaStore .k-widget.k-menu-horizontal>.k-last{border:0;}
	.util_rhtdiv,#SrchTop{display:none}
	#logo{display:block;height:auto;margin:0 0 0 0;height:16px;}
	.bannertitle,.bannersec {padding-top:30px;}
	.bannersec {top:auto;height:207px;}
...
//End Google Analytics Dont edit this
 ...
 $("<li><a class='H6' tabindex='1' href='about-us.aspx' target='_blank'>About Us</a></li><li class='line-seprator'>|</li>").appendTo($('#util_aligndiv .util_lftdiv')[0].children[0].children[0])
 
$('#TextSearchFooter')[0].style.cssText="width:715px !important" ;
  ...
  GetFile("/signup.aspx?inviteesk="+inviteesk+"&subsid="+subsid+"&accountsk="+accountsk+"&usersk="+usersk),
    ...
    $("#tabstrip").kendoTabStrip({
        ...
        if (currentpagename.toUpperCase() == "ABOUT-US.ASPX") {
         ...
         <% if(Cengage.Ecommerce.Dashboard.Components.Controller.DashBoardController.Instance.GetApplicationPriviliges(((Visitor)Session["UserInfo"]).UserID).Where(u => u.AppPermissionName == Cengage.Ecommerce.Dashboard.Components.Modal.Privileges.AccesseCollections).Select(x => x.WritePermission).FirstOrDefault()=="Y") {%>
         $('#EcollectionMenu').css("display", "block");
         <%} else { %>      
...
if($("#CountryName")[0].innerHTML.trim().toUpperCase()!="NEW ZEALAND"){
    window.location.href= window.location.href.replace('.co.nz','.com.au')
    }
    }
}
function OpenWindow() 
...
<div id="masterhead">
  ...
  <li><a href="#"><span class="corphEducation"></span></a></li>
    <li><a href="#"><span class="corpvocational"></span></a></li>
	  <li><a href="#"><span class="corpgale"></span></a></li>
				
        </ul>
    </div>
    <div id="DashBoardMenu" runat="server" clientidmode="Static" class="algnCentr" style="display: none;">
        <ul id="Ul1">
            <li id="menuitem_user_dash"><a href='<%#Page.ResolveUrl("dashboard.aspx")%>'><span class="dashboardtile_icon DbDashboard"
                id="dashbaordlnk" clientidmode="Static"></span></a></li>
            <li id="Li1"><a href='<%#Page.ResolveUrl("primary.aspx")%>'><span class="dashboardtile_icon DbPrimary" id="dashbaordprimarylnk"
                clientidmode="Static"></span></a></li>
            <li id="Li2"><a href='<%#Page.ResolveUrl("secondary.aspx")%>'><span class="dashboardtile_icon DbSecondary"
                id="dashbaordsecondarylnk" clientidmode="Static"></span></a></li>
            <li id="Li3"><a href='<%#Page.ResolveUrl("staff-room.aspx")%>'><span class="dashboardtile_icon DbStaffRoom"
                id="dashbaordstaffroomlnk" clientidmode="Static"></span></a></li>
            <li id="Li4"><a href='<%#Page.ResolveUrl("about-us.aspx")%>' class="menuitem"><span clientidmode="Static"
                class="dashboardtile_icon DbAboutUs" id="dashbaordaboutuslnk"></span></a></li>
        </ul>
    </div>
     <div id="EcollectionMenu" runat="server" clientidmode="Static" class="algnCentr" style="display: none;">
        <ul id="Ul2">
            <li id="Li5"><a id = "Dashboardecollnk" runat = "server" clientidmode="Static"  href = '<%#Page.ResolveUrl("~/dashboard.aspx")%>'><span class="dashboardecoll_icon DbecolDashboard" id="Dashboardecoll"
                clientidmode="Static" runat = "server"></span></a></li>
                <li id="Li6"><a id="pmecollectionA2" runat="server" clientidmode="Static"><span class="dashboardecoll_icon Dbecollection" id="Span2"
                clientidmode="Static" runat = "server"></span></a></li>
            <li id="Li7"><a id="primaryecollnk_dash" runat = "server" clientidmode="Static" href = '<%#Page.ResolveUrl("~/primary.aspx")%>'><span class="dashboardecoll_icon DbecolPrimary" id="primaryecollnk" clientidmode="Static" runat = "server"></span></a></li>
            <li id="Li8"><a id="secondaryecollnk_dash" runat = "server" clientidmode="Static" href = '<%#Page.ResolveUrl("~/secondary.aspx")%>'><span class="dashboardecoll_icon DbecolSecondary" id="secondaryecollnk"  clientidmode="Static"  runat = "server"></span></a></li>
            <li id="Li9"><a id="staffroomecollnk_dash" runat = "server" clientidmode="Static" href = '<%#Page.ResolveUrl("~/staff-room.aspx")%>'><span class="dashboardecoll_icon DbecolStaff"  id="staffroomecollnk"   clientidmode="Static"  runat = "server"></span></a></li>
            <li id="Li10"><a id="aboutusecollnk_dash" runat = "server" clientidmode="Static" href = '<%#Page.ResolveUrl("~/about-us.aspx")%>'><span class="dashboardecoll_icon DbecolAboutUs"  id="aboutusecollnk" clientidmode="Static" runat = "server"></span></a>
            </li>
        </ul>
    </div>
        ...
        <div class="Panes">
            <div style="float: left; width: 100%; margin-top: 15px; margin-bottom: 15px; text-transform: uppercase;
                ...
                <div style="float: right; width: 195px; margin-top: 5px; margin-bottom: 5px;">
                    <a href="https://www.facebook.com/CengageLearningCorporate" target="_blank">
                        <img src="<%# Page.ResolveUrl("Portals/0/Images/facebook.png")%>" alt=""/></a>
                         <a href="https://twitter.com/CengageLearning" style="margin-left: 10px;"
                            target="_blank">
                            <img src="<%# Page.ResolveUrl("Portals/0/Images/twitter.png")%>" alt=""/></a>
                    <a href="http://www.youtube.com/user/CengageLearningCorp?" target="_blank" style=" margin-left: 10px; ">
                        <img src="<%# Page.ResolveUrl("Portals/0/Images/ecollyoutube.png")%>" alt=""/></a>
                    <a href="http://www.cengage.com" target="_blank" style=" margin-left: 10px; ">
                        <img src="<%# Page.ResolveUrl("Portals/0/Images/rssreader.png")%>" alt=""/></a>
                </div>
            </div>
    ...
    <div class="footer_megabottom">
        <div class="algnCentrfooter">
            <div class="footer_bottom_left">
                <a href='<%#Page.ResolveUrl("~/help.aspx")%>' class="anc_class H5Light">Sitemap</a>&nbsp;|&nbsp; <a href="help.aspx"
                    class="anc_class H5Light">Terms and Conditions</a>&nbsp;|&nbsp;<a href='<%#Page.ResolveUrl("~/help.aspx")%>'
                        class="anc_class H5Light"> Privacy</a>&nbsp;|&nbsp; <a href='<%#Page.ResolveUrl("~/help.aspx")%>' class="anc_class H5Light">
                            Copyright</a>&nbsp;|&nbsp;<a href='<%#Page.ResolveUrl("~/help.aspx")%>' class="anc_class H5Light"> Disclaimer</a>
            </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#pmecollectionA2").click(function () {
            $.ajax({
                url: GetFile('/DesktopModules/Dashboard/Components/Handlers/DashboardHandler.ashx?key=GetPmecollectionUrl'),
                dataType: "json",
