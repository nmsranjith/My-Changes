...
namespace DotNetNuke.Modules.SampleRequestForm.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.SampleRequestForm.Data.SqlDataprovider,SampleRequestForm";
        ...
        public abstract string InsertOrders(SRFParameters sRFParameters, DataTable orderDt, string typeofsale, string FormatType);
        public abstract IDataReader GetInstructorInfo(string UserLoginName);
        public abstract int SaveSSOInstructorInfo(SRFParameters user);
        public abstract int SRFSendMail(string toAddress, string mailBody, string mailSubject);
        #endregion
    }
