...
namespace DotNetNuke.Modules.ProductFormat
{
    ...
    /// 
    /// Because the control inherits from ProductFormatSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : ProductFormatSettingsBase
    {
