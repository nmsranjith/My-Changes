...
namespace DotNetNuke.Modules.eCollection_Banner
{
    ...
    /// 
    /// Because the control inherits from eCollection_BannerSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : eCollection_BannerSettingsBase
    {
