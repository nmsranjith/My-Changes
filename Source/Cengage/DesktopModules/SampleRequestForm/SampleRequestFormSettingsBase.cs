...
namespace DotNetNuke.Modules.SampleRequestForm
{
    ...
    /// are accessible to your module's controls (that inherity from SampleRequestFormSettingsBase
    /// 
    /// </summary>


    public class SampleRequestFormSettingsBase : ModuleSettingsBase
    {
