...
namespace DotNetNuke.Modules.eCollection_FeatureSlider
{
    ...
    /// are accessible to your module's controls (that inherity from eCollection_FeatureSliderModuleBase
    /// 
    /// </summary>

    public class eCollection_FeatureSliderModuleBase : DotNetNuke.Entities.Modules.PortalModuleBase
    {
    }
}
