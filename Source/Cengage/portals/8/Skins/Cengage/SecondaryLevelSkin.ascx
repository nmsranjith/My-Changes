    ...
    <div class="bannersec">
        <div id="bannertitlePane" runat="server" class="bannertitle algnCentr">
           <h1>
                ...
                <asp:Label ID="lblbannertxt" runat="server" Text="" ClientIDMode="Static" style="display:none;"></asp:Label>
            </h1>
        </div>
    </div>
</div>
        ...
        <div class="Panes">
          <div style="float: left; width: 100%; margin-top: 15px; margin-bottom: 15px; text-transform: uppercase; border-bottom: 1px solid #B7AAAA">
              ...
              <div style="float: right; width: 195px; margin-top: 5px; margin-bottom: 5px;">
                    <a href="https://www.facebook.com/NelsonSecondaryAustralia" target="_blank">
                    ...
                    <a href="https://www.youtube.com/NelsonSecondaryVideo" target="_blank" style=" margin-left: 10px; ">
