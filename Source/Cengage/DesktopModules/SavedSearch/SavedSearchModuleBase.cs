...
namespace DotNetNuke.Modules.SavedSearch
{
    ...
    /// are accessible to your module's controls (that inherity from SavedSearchModuleBase
    /// 
    /// </summary>

    public class SavedSearchModuleBase : DotNetNuke.Entities.Modules.PortalModuleBase
    {
        /// <summary>
