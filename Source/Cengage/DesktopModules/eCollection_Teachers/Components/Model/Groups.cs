...
namespace DotNetNuke.Modules.eCollection_Teachers.Components.Model
{
    ...
    public class Groups : ContentItem, IComparable<Groups>, IHydratable
    {
        ...
        {          
            ...
            TeacherName = CultureInfo.CurrentCulture.TextInfo.ToTitleCase(Null.SetNullString(ConcatTeacherName(TeacherController.Instance.GetTeacherName(GroupId))));
        ...
        // </copyright>
        // <summary>
        //    Comparer for Groups Reading Level
        // </summary>
        // ---------------------------------------------------------------------------------------------------------------------
