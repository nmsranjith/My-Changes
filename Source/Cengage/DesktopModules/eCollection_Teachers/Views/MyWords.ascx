<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MyWords.ascx.cs" Inherits="DotNetNuke.Modules.eCollection_Teachers.Views.MyWords" %>
...
<span id="teacherIdLabel" runat="server" clientidmode="Static" style="display: none;">
</span>
<script type="text/javascript">
    ...
    function ClearWords(id, duration) {
        $.ajax({
            url: GetFile('/DesktopModules/eCollection_Teachers/Handlers/eCollectionHandler.ashx?autocomplete=clearfromiPad&duration=' + duration + '&teacherId=' + jQuery('#teacherIdLabel').text()),
            type: "GET",
    ...
    function ClearMonthWord(id, Month) {
        $.ajax({
            url: GetFile('/DesktopModules/eCollection_Teachers/Handlers/eCollectionHandler.ashx?autocomplete=clearfromiPad&duration=monthwise&Month=' + Month + '&teacherId=' + jQuery('#teacherIdLabel').text()),
            type: "GET",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (res) {
    ...
    function CheckClearFromiPad(id, duration) {
        debugger;
        $.ajax({
            url: GetFile('/DesktopModules/eCollection_Teachers/Handlers/eCollectionHandler.ashx?autocomplete=checkclearfromiPad&teacherId=' + jQuery('#teacherIdLabel').text() + '&duration=' + duration),
            type: "GET",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (res) {
