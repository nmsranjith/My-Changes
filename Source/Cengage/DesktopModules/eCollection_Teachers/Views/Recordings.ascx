<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Recordings.ascx.cs"
    Inherits="DotNetNuke.Modules.eCollection_Teachers.Views.Recordings" %>
...
<script type="text/javascript">
    ...
    function hidetab() {
        jQuery('#eCollectionContent').height((jQuery('#FirstDiv').height() + jQuery('#SecondDiv').height() + 70) + 'px');
        jQuery('#eCollectionMenu').height((jQuery('#eCollectionContent').height() - 14) + 'px');
    }
    function showtab() {
        jQuery('#eCollectionContent').height((jQuery('#FirstDiv').height() + jQuery('#SecondDiv').height() + 100) + 'px');
        jQuery('#eCollectionMenu').height((jQuery('#eCollectionContent').height() - 14) + 'px');
    }
