...
<%@ Register TagPrefix="dnn" Namespace="DotNetNuke.Web.Client.ClientResourceManagement"
	...
	<dnn:DnnCssInclude runat="server" FilePath="Resources/Shared/scripts/Bootstrap/css/custom.css?v=2" />
	...
	<dnn:BROWSESEARCH runat="server" id="BrowseSearch" clientidmode="Static" />
        ...
        <div class="Panes">
		 <% if(PortalSettings.Current.ActiveTab.ParentId!=-1 && PortalSettings.Current.HomeTabId!=PortalSettings.Current.ActiveTab.TabID) {%>
			...
			<% }%>
               <div id="TopPane" runat="server" class="divlvltopoan"></div>
                 <div id="LeftPane" runat="server" class="divlvlleftpan"></div>


                 <div class="divlvlimgdiv"> 				 
                 <div class="divlvlimgdiv1">
                  <img alt="" id="imgsepline" src="/Portals/0/images/separatorarrow.Png"></div></div>

          
				  <div class="divlvlcontpanediv">
                  <div id="ContentPane" runat="server" class="divlvlcontpane">   </div>
				  </div>
