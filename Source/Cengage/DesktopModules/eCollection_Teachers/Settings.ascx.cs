...
namespace DotNetNuke.Modules.eCollection_Teachers
{
    ...
    /// 
    /// Because the control inherits from eCollection_TeachersSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : eCollection_TeachersSettingsBase
    {
