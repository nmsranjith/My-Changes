<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Recordings.ascx.cs"
    Inherits="DotNetNuke.Modules.eCollection_Students.Views.Recordings" %>
<%@ Register Src="eCollectionMessages.ascx" TagName="Messages" TagPrefix="Msg" %>
<link href="<%=Page.ResolveUrl("DesktopModules/eCollection_Students/CSS/jplayer.css")%>"
    rel="Stylesheet" type="text/css" />
<link href="<%=Page.ResolveUrl("DesktopModules/eCollection_Students/CSS/jplayer.blue.monday.css")%>"
    rel="Stylesheet" type="text/css" />
<Msg:Messages ID="Messages" runat="server">
</Msg:Messages>
<div id="FirstDiv" class="MyRecordings_TopDiv">
    <h3 id="MyRecordingsHeader" class="MyRecordingsHeader">
        Recordings</h3>
    <div id="MyRecordingsCount" class="MyRecordingsCount">
        <font id="MyRecordingsCnt" runat="server" face="Arial"></font> RECORDING/S SAVED</div>
</div>
<div style="margin: 18px 10px 0px 21px; float: left; z-index: 1000; position: relative;">
    <a id="BackButton" runat="server" style="color: #20B3E6; text-decoration: none; font-size: 10pt;">
        Back to profile</a>
</div>
<div id="SecondDiv" class="Div_FullWidth" runat="server" clientidmode="Static">
    <div id="HistoryMainDiv" class="HistoryMainDiv" runat="server" clientidmode="Static">
                            ...
                            <div class="HistoryContentHolder">
                                ...
                                <div class="HistoryContent">
                                    ...
                                    <div class="HistoryContent_BookCover">
                                        <asp:Image ID="BookCoverImage" AlternateText="Cover" ImageUrl='<%#Eval("ImageUrl") %>' ClientIDMode="Static"
                                    ...
                                    <div class="HistoryContent_ReadDetails">
                                        <div style="width: 100%; float: left; padding-top: 35px; font-size: 10pt; color: Gray;
                                            padding-bottom: 63px;">
        ...
        <div id="Last7DaysHistory" runat="server" clientidmode="Static" class="HistoryDiv">
            ...
            <div id="Last7DaysBorderDiv">
                <div id="Last7DaysRecDiv" class="MyHistoryHolder_Content">
                    <asp:ListView ID="Last7DaysIndependentRecordings" runat="server" DataKeyNames="OpenedDate"
                        OnItemDataBound="IndependentGrid_RowDataBound">
                        <ItemTemplate>
                            <div class="HistoryContentHolder">
                                <div class="HistoryNodeImage">
        ...
        <div id="RestoftheMonthHistory" runat="server" clientidmode="Static" class="HistoryDiv">
            ...
            <div id="RestBorderDiv">
                <div id="RestRecordingsDiv" class="MyHistoryHolder_Content">
                    <asp:ListView ID="RestIndependentHistory" DataKeyNames="OpenedDate" runat="server"
                        OnItemDataBound="IndependentGrid_RowDataBound">
                        <ItemTemplate>
                            <div class="HistoryContentHolder">
                                <div class="HistoryNodeImage">
        ...
        <div id="MonthwiseHistories" runat="server" clientidmode="Static">
            <asp:ListView ID="MonthWiseHistory" runat="server" OnItemDataBound="MonthWiseWordLogs_BindInfo"
                ...
                <ItemTemplate>
                    <div class="HistoryDiv">
                        <div id="MonthWiseRecordings" class="RecordingsHolder">
                            ...
                            <div class="TodayHistory_Name" onclick="toggle_visibility('MonthWiseRecordingsDiv<%# Container.DataItemIndex %>','MonthWiseBorderDiv<%# Container.DataItemIndex %>');">
                                <div style="float: left; width: 8%; margin-left: 13px; margin-top: 10px;">
                                    <asp:Image ID="RestCalImage" runat="server" ImageUrl="~/Portals/0/images/callender.png"
                                        CssClass="StudentDashBoard_GuidedImage" />
                                </div>
                                <div class="His_LabelDiv His_LabelDivUp">
                                    <asp:Label ID="MonthWiseLabel" runat="server"><%# Eval("OpenedMonths")%></asp:Label>
                                </div>
                            </div>
                        </div>
                        <div id="MonthWiseBorderDiv<%# Container.DataItemIndex %>">
                            <div id="MonthWiseRecordingsDiv<%# Container.DataItemIndex %>" class="MyHistoryHolder_Content">
                                <asp:ListView ID="MonthWiseIndependentRecordings" runat="server" DataKeyNames="OpenedDate"
                                    OnItemDataBound="MonthIndependentGrid_RowDataBound">
                                    <ItemTemplate>
                                        <div class="HistoryContentHolder">
                                            <div class="HistoryNodeImage">
                                                <asp:Image ID="NodeImage" runat="server" ImageUrl="~/Portals/0/images/circle_big.png" />
...
<div id="LastNodeDiv" runat="server" clientidmode="Static" class="LastNodeDiv">
...
<script type="text/javascript">
    ...
    function hidetab() {
        jQuery('#eCollectionContent').height((jQuery('#FirstDiv').height() + jQuery('#SecondDiv').height() + 80) + 'px');
        jQuery('#eCollectionMenu').height((jQuery('#eCollectionContent').height() - 14) + 'px');
    }
    function showtab() {
        jQuery('#eCollectionContent').height((jQuery('#FirstDiv').height() + jQuery('#SecondDiv').height() + 110) + 'px');
        jQuery('#eCollectionMenu').height((jQuery('#eCollectionContent').height() - 14) + 'px');
    }
...
<script src="<%=Page.ResolveUrl("DesktopModules/eCollection_Students/Scripts/jquery.jplayer.min.js")%>"
    type="text/javascript"></script>
<script src="<%=Page.ResolveUrl("DesktopModules/eCollection_Students/Scripts/jplayer.playerlist.min.js")%>"
    type="text/javascript"></script>
