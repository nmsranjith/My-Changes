...
namespace DotNetNuke.Modules.LibraryResources.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.LibraryResources.Data.SqlDataprovider,LibraryResources";
        ...
        public abstract SqlDataReader GetLibraryResources();

        public abstract int SaveLibraryResources(List<LibraryResource> libResourceList);
