...
namespace DotNetNuke.Modules.eCollection_Groups
{
    ...
    /// are accessible to your module's controls (that inherity from eCollection_GroupsSettingsBase
    /// 
    /// </summary>


    public class eCollection_GroupsSettingsBase : ModuleSettingsBase
    {
