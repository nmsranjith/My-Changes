...
namespace DotNetNuke.Modules.eCollection_FeatureSlider
{
    ...
    /// are accessible to your module's controls (that inherity from eCollection_FeatureSliderSettingsBase
    /// 
    /// </summary>


    public class eCollection_FeatureSliderSettingsBase : ModuleSettingsBase
    {
