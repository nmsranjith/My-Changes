...
<div id="logo">
    <div class="algnCentr">
        <a id="hypLogo" title="Cengage Learning - Australia" href="/">
            <img id="imgLogo" src="/Portals/0/Images/cengange_home_logo.gif" alt="Cengage Learning - Australia"
...
<div class="middlecont" style="margin-top: -25px; min-height: 580px;">
    <div class="contCentr">
        <div class="Panes">
            ...
            <div id="LeftPane" runat="server" style="float: left; clear: both; display: inline-block;
                z-index: 5; width: 220px; margin-bottom: 10px;" class="leftPaneBorder">
            </div>
            <div style="width: 10px; float: left;">
                <div style="position: absolute; height: 100%; display: block; margin: 30px 0 0 0;
                    z-index: 30">
                    <img id="imgsepline" alt="" src="/Portals/0/images/separatorarrow.Png">
                </div>
            </div>
            <div style="position: relative; width: 715px; position: relative; display: block;
                z-index: 12; min-height: 400px; float: left; height: auto; border-left: 1px #ccc solid;
                margin-bottom: 20px;">
                <div id="ContentPane" runat="server" style="margin: -22px 0 0 20px;">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="footer_megabottom">
        <div class="algnCentrfooter">
            <div class="footer_bottom_left">
                <a href="/terms-and-conditions" class="anc_class H5Light">Terms and Conditions</a>&nbsp;|&nbsp;<a
                    href='/privacy' class="anc_class H5Light"> Privacy</a>&nbsp;|&nbsp; <a href='/copyright'
                        class="anc_class H5Light">Copyright</a>&nbsp;|&nbsp;<a href='/disclaimer' class="anc_class H5Light">
                            Disclaimer</a>
            </div>
