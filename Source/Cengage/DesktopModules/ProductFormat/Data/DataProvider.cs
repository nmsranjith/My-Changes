...
namespace DotNetNuke.Modules.ProductFormat.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.ProductFormat.Data.SqlDataprovider,ProductFormat";
        ...
        public abstract SqlDataReader GetAllProductFormats();

        public abstract int SaveProductFormats(List<ProductFormats> lstProductFormat);
