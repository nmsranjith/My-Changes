...
namespace DotNetNuke.Modules.FavouriteAndRecentlyViewed
{
    ...
    /// are accessible to your module's controls (that inherity from FavouriteAndRecentlyViewedSettingsBase
    /// 
    /// </summary>


    public class FavouriteAndRecentlyViewedSettingsBase : ModuleSettingsBase
    {
