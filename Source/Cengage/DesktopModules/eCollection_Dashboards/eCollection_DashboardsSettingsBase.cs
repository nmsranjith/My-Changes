...
namespace DotNetNuke.Modules.eCollection_Dashboards
{
    ...
    /// are accessible to your module's controls (that inherity from eCollection_DashboardsSettingsBase
    /// 
    /// </summary>


    public class eCollection_DashboardsSettingsBase : ModuleSettingsBase
    {
