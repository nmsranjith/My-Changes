...
namespace DotNetNuke.Modules.eCollection_FeatureSlider.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.eCollection_FeatureSlider.Data.SqlDataprovider,eCollection_FeatureSlider";
