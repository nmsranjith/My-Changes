...
namespace DotNetNuke.Modules.eCollection_Banner.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.eCollection_Banner.Data.SqlDataprovider,eCollection_Banner";
