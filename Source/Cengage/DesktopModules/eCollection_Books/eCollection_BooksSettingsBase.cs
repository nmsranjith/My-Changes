...
namespace DotNetNuke.Modules.eCollection_Books
{
    ...
    /// are accessible to your module's controls (that inherity from eCollection_BooksSettingsBase
    /// 
    /// </summary>


    public class eCollection_BooksSettingsBase : ModuleSettingsBase
    {
