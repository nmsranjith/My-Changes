...
.backgrdimage 
   {
	...
	#masterhead {
	 background: url('./portals/0/images/bg_middle.png') no-repeat center 12px !important;
	}
...
<script type="text/javascript">
 ...
 $("<li><a class='H6' tabindex='1' href='/about-us.aspx'>About Us</a></li><li class='line-seprator'>|</li>").prependTo($('#util_aligndiv .util_lftdiv')[0].children[0])
...
function onCountryClose()
		...
		if($('#CountryName')[0].innerHTML.toLowerCase().indexOf("international")>-1){
			document.location.href=location.protocol+"//"+"cengage.com.au";
		}
		else{
...
<div id="logo">
    <div class="algnCentr">
	 <a id="hypLogo" title="Cengage Learning - New Zealand" href="/"><img id="imgLogo" src="/Portals/0/Images/cengange_home_logo.gif" alt="Cengage Learning - New Zealand" style="border-width:0px;" /></a>    
    </div>
</div>
<div id="masterhead">
    ...
    <div class="contCentr">
        <div class="Panes">
            <div style="float: left; width: 100%; margin-top: 15px; margin-bottom: 15px; text-transform: uppercase;
                border-bottom: 1px solid #B7AAAA;padding-bottom: 5px;">
