<%@ Control Language="C#" CodeBehind="NewAndNotableHandler_Edit.ascx.cs" Inherits="DotNetNuke.Modules.NewAndNotable.DynamicData.FieldTemplates.NewAndNotableHandler_EditField" %>
