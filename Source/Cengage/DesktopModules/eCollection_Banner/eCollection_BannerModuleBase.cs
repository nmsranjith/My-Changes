...
namespace DotNetNuke.Modules.eCollection_Banner
{
    ...
    /// are accessible to your module's controls (that inherity from eCollection_BannerModuleBase
    /// 
    /// </summary>

    public class eCollection_BannerModuleBase : DotNetNuke.Entities.Modules.PortalModuleBase
    {
    }
}
