...
<link href="/Resources/Shared/stylesheets/Homelevelskin.css" rel="stylesheet" type="text/css" />
<dnn:STYLES runat="server" ID="StylesIE8" Name="IE8Minus" StyleSheet="ie8skin.css"
    Condition="LT IE 9" UseSkinPath="true" />
<script type="text/javascript" src="/Resources/Shared/scripts/HomeLevelSkin.js"> </script>
...
<div class="middlecont" style="margin-top:-25px;min-height:580px;">
    <div class="contCentr">
        <div class="Panes">
          <div style="float: left; width: 100%; margin-top: 15px; margin-bottom: 15px; text-transform: uppercase; border-bottom: 1px solid #B7AAAA;padding-bottom: 5px;">
        ...
        <div id="TopPane" runat="server" style="clear: both; display: inline-block; z-index: 5;
            ...
            <div id="LeftPane" runat="server" style="float:left; clear: both; display: inline-block; z-index: 5;
                width: 220px; margin-bottom:10px;" class="leftPaneBorder">
            </div>
