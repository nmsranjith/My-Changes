...
namespace DotNetNuke.Modules.LibraryResources
{
    ...
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class View : LibraryResourcesModuleBase, IActionable
    {
        ...
        private void Page_Load(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                LeftLibraryResourcesRptr.DataSource = reader;
                LeftLibraryResourcesRptr.DataBind();
                reader.NextResult();
                RightLibraryResourcesRptr.DataSource = reader;
                RightLibraryResourcesRptr.DataBind();
            }
