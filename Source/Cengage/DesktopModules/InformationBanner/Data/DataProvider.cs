...
namespace DotNetNuke.Modules.InformationBanner.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.InformationBanner.Data.SqlDataprovider,InformationBanner";
        ...
        public abstract SqlDataReader GetAlerts(string val, string currentDate, string userLoginName);
        public abstract int AddAlerts(int usersk,string ErrorMsg, string ErrorType, string StartDate, string EndDate);
        public abstract int DeleteAlerts(int AlertID);
        public abstract int UpdateAlerts(int AlertID, string ErrorMsg, string ErrorType, string StartDate, string EndDate);
        public abstract int DeleteUserInfoID(int AlertID, string userLoginName, string pageUrl);
    }
